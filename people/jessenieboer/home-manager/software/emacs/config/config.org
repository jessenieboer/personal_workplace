...
:END:
h = leader key for general emacs stuff
f12 = leader key for help/info stuff
i = leader key for mode-specific stuff
#+begin_src emacs-lisp
...
d- = test region
dh = test buffer/file
dc = test project verbose

# debug

# lsp
g/p = lsp ref navigation
dy = peek def
dk = peek ref
hg = lsp imenumenu
...
v/x = file nav
ret = goto xref
d = goto xref other window
f = abort

di = leader key for ai stuff?
...
*** ediff
:PROPERTIES:
:ID:       1940a712-9321-43df-9a92-f5a2591d6609
:END:
#+begin_src emacs-lisp
...
**** ediff controls
:PROPERTIES:
:ID:       7a0b4b79-6d74-42ce-97a0-d1e222f09ae9
:END:
#+begin_src emacs-lisp
  (my-add-to-hydra main-modes
  		 ("Connection"
...
*** racket
:PROPERTIES:
:ID:       17956bf6-4154-470b-a6c9-5b8a6fdf8c33
:END:
#+begin_src emacs-lisp
    (require 'racket-mode)
